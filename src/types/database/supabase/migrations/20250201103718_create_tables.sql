...
CREATE TABLE IF NOT EXISTS recurrings (
    ...
    transferaccountid uuid NOT NULL REFERENCES accounts(id),
    ...
    recurringtype RecurringTypes DEFAULT 'Standard',
