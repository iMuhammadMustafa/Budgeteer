...
const getAccountsData = (transactions: any[]) => {
  ...
  return [
    // Bank Accounts
    {
      ...
      notes: null,
      owner: WATERMELONDB_DEFAULT_USER_ID,
      displayorder: 1,
...
const generateTransactionsData = () => {
  ...
  transactions.push({
    ...
    amount: 500,
    date: openingBalanceDate.toISOString().split("T")[0],
  ...
  while (ccPaymentDate <= today) {
    ...
    transactions.push({
      ...
      date: ccPaymentDate.toISOString().split("T")[0],
  ...
  while (loanPaymentDate <= today) {
    ...
    transactions.push({
      ...
      date: loanPaymentDate.toISOString().split("T")[0],
