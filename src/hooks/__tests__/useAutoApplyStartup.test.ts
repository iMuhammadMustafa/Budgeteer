...
import { useAutoApplyStartup, useAutoApplyRecurrings } from "../useAutoApplyStartup";
...
describe("useAutoApplyStartup", () => {
  ...
  describe("useAutoApplyStartupSimple", () => {
    it("should auto-initialize on mount", () => {
      const { result } = renderHook(() => useAutoApplyRecurrings());
  ...
  describe("performance considerations", () => {
    it("should not block app startup with delayed execution", () => {
      ...
      renderHook(() => useAutoApplyRecurrings({ delayMs: 2000 }));
