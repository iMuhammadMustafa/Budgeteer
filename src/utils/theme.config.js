...
export const lightVars = {
  ...
  "--color-primary-0": "247 252 252",
  "--color-primary-50": "239 250 250",
  "--color-primary-100": "223 244 244",
  "--color-primary-200": "191 233 233",
  "--color-primary-300": "158 222 223",
  "--color-primary-400": "126 211 212",
  "--color-primary-500": "94 200 201",
  "--color-primary-600": "85 180 181",
  "--color-primary-700": "66 140 141",
  "--color-primary-800": "47 100 100",
  "--color-primary-900": "28 60 60",
  "--color-primary-950": "14 30 30",
  ...
  "--color-page-bg": "250 249 246",
  "--color-panel-bg": "242 240 234",
  "--color-heading": "24 24 27",
  "--color-subtext": "0 0 0",
  "--color-accent-green": "46 160 110",
  "--color-accent-green-light": "44 184 122",
  "--color-card-glass": "255 255 255",
  "--color-card-border": "0 0 0",
  "--color-hero-card": "255 255 255",
  "--color-hero-card-border": "0 0 0",
  "--color-hero-label": "0 0 0",
  "--color-hero-amount": "24 24 27",
  "--color-float-card": "255 255 255",
  "--color-float-card-border": "0 0 0",
  "--color-float-text": "0 0 0",
  "--color-badge-bg": "44 184 122",
  "--color-badge-border": "44 184 122",
  "--color-badge-text": "26 158 98",
  "--color-bar-primary": "59 138 110",
  "--color-bar-accent": "44 184 122",
  "--color-heading-grad-start": "26 158 98",
  "--color-heading-grad-end": "40 128 176",
  "--color-mode-card-bg": "255 255 255",
  "--color-mode-card-border": "0 0 0",
  "--color-mode-title": "24 24 27",
  "--color-mode-desc": "0 0 0",
  "--color-hint": "0 0 0",
  "--color-toggle-track": "209 234 217",
  "--color-toggle-knob": "255 255 255",
  "--color-toggle-label": "0 0 0",
  "--color-toggle-bg": "0 0 0",
  "--color-toggle-border": "0 0 0",
  "--color-trust-icon": "0 0 0",
  "--color-trust-text": "0 0 0",
  "--color-feature-icon-border": "230 230 230",
  "--color-feature-text": "80 80 85",
  "--color-stat-card-bg": "255 255 255",
  "--color-stat-border": "0 0 0",
...
export const darkVars = {
  ...
  /* Landing Page Palette */
  "--color-page-bg": "24 24 28",
  "--color-panel-bg": "20 20 24",
  "--color-heading": "240 237 232",
  "--color-subtext": "255 255 255",
  "--color-accent-green": "93 220 154",
  "--color-accent-green-light": "93 220 154",
  "--color-card-glass": "28 28 32",
  "--color-card-border": "255 255 255",
  "--color-hero-card": "32 32 38",
  "--color-hero-card-border": "255 255 255",
  "--color-hero-label": "255 255 255",
  "--color-hero-amount": "240 237 232",
  "--color-float-card": "36 36 42",
  "--color-float-card-border": "255 255 255",
  "--color-float-text": "255 255 255",
  "--color-badge-bg": "93 220 154",
  "--color-badge-border": "93 220 154",
  "--color-badge-text": "93 220 154",
  "--color-bar-primary": "59 138 110",
  "--color-bar-accent": "93 220 154",
  "--color-heading-grad-start": "93 220 154",
  "--color-heading-grad-end": "59 191 160",
  "--color-mode-card-bg": "36 36 42",
  "--color-mode-card-border": "255 255 255",
  "--color-mode-title": "240 237 232",
  "--color-mode-desc": "255 255 255",
  "--color-hint": "255 255 255",
  "--color-toggle-track": "42 110 83",
  "--color-toggle-knob": "93 220 154",
  "--color-toggle-label": "255 255 255",
  "--color-toggle-bg": "255 255 255",
  "--color-toggle-border": "255 255 255",
  "--color-trust-icon": "255 255 255",
  "--color-trust-text": "255 255 255",
  "--color-feature-icon-border": "55 55 62",
  "--color-feature-text": "180 180 185",
  "--color-stat-card-bg": "36 36 42",
  "--color-stat-border": "255 255 255",
...
export const convertThemeToReactNativeColors = mode => {
...
export const convertThemeToRgb = mode => {
  const styles = mode === "dark" ? darkVars : lightVars;
  const rgb = color => `rgb(${color.replace(/ /g, ",")})`;
