...
import AccountForm, { initialState } from "../AccountForm";
...
describe("AccountForm", () => {
  ...
  describe("Form Data Initialization", () => {
    ...
    it("should update form when initial data changes", async () => {
      ...
      const updatedAccount: AccountFormData = {
        ...defaultAccount,
  ...
  describe("Running Balance Sync", () => {
    it("should show sync button when running balance differs from balance", () => {
      const accountWithRunningBalance: AccountFormData = {
        ...defaultAccount,
        balance: 1000,
        runningbalance: 1200,
      };
  ...
  describe("Open Balance Handling", () => {
    it("should show open balance field when account has opening transaction", () => {
      ...
      const accountWithOpenBalance: AccountFormData = {
        ...defaultAccount,
        openBalance: 500,
      };
  ...
  describe("Form Reset", () => {
    ...
    it("should preserve open balance field when resetting form", async () => {
      const accountWithOpenTransaction: AccountFormData = {
        ...defaultAccount,
        openBalance: 500,
      };
