        ...
        <View className="bg-card rounded-xl p-4 mb-4 border border-muted flex-1 h-full">
          <View className="flex-row items-center mb-3">
            ...
            <View className="ml-3 flex-1">
              ...
              <Text className="text-sm text-muted-foreground">Download your data as JSON or CSV</Text>
            </View>
          </View>
          ...
          <View className="bg-muted/30 rounded-lg p-3 mb-4">
            ...
            <Text className="text-xs text-muted-foreground ml-6">
              Complete backup including all tables and configuration. Use for migrations between storage modes or device
              transfers.
            </Text>
          </View>
        ...
        <View className="bg-card rounded-xl p-4 mb-4 border border-muted flex-1 h-full">
          <View className="flex-row items-center mb-3">
            ...
            <View className="ml-3 flex-1">
              ...
              <Text className="text-sm text-muted-foreground">Restore data from a JSON export file</Text>
            </View>
          </View>
            ...
            <View className="flex-row items-start mb-2">
              ...
              <View className="ml-2 flex-1">
                ...
                <Text className="text-xs text-muted-foreground mt-1">
                  The system automatically detects tables, validates dependencies, and skips existing records. No manual
