...
export const MODEL_EXPORT_IMPORT_CONFIG: ModelConfig[] = [
  {
    ...
    ignoredFields: [],
    ignoredExportFields: ["statementdate"],
    ignoredImportFields: ["statementdate"],
  },
  {
    ...
    ignoredFields: [],
    ignoredExportFields: ["category", "runningbalance"],
    ignoredImportFields: ["category", "runningbalance"],
  },
  {
  ...
  },
  {
    ...
    ignoredFields: [],
    ignoredExportFields: ["group"],
    ignoredImportFields: ["group"],
  },
  {
  ...
  },
  {
    ...
    importEnabled: true,
    dependencies: [TableNames.Accounts, TableNames.TransactionCategories],
    requiredFields: ["id", "sourceaccountid", "tenantid"],
    uniqueFields: ["id"],
    dateFields: ["nextoccurrencedate", "enddate", "lastexecutedat", "lastautoappliedat", "createdat", "updatedat"],
    fields: [
      "id",
      "name",
      "sourceaccountid",
