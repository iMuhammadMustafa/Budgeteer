...
import { createRecurringHelper, executeRecurringHelper, executeTransferLogic } from "../Recurring.Service";
  ...
  describe("CRUD Operations", () => {
    describe("Create Enhanced Recurring", () => {
      it("should create a standard recurring transaction successfully", async () => {
        ...
        // Act
        const result = await createRecurringHelper(recurringData, mockSession, mockRecurringRepo);
      ...
      it("should fail validation for invalid interval months", async () => {
        ...
        // Act & Assert
        await expect(createRecurringHelper(invalidRecurringData, mockSession, mockRecurringRepo)).rejects.toThrow(
          "Validation failed",
        );
      });
      ...
      it("should allow validation when both amount and date are flexible", async () => {
        ...
        // Act
        const result = await createRecurringHelper(validRecurringData, mockSession, mockRecurringRepo);
  ...
  describe("Execution Methods", () => {
    describe("Execute Recurring Transaction", () => {
      it("should execute a standard recurring transaction successfully", async () => {
        ...
        expect(mockAccountRepo.updateAccountBalance).toHaveBeenCalledWith("checking-account-id", 200, "test-tenant-id");
