import { updateTransactionHelper } from "./path/to/updateTransactionHelper";
import { updateTransaction, updateAccountBalance } from "./path/to/services";
import { Session } from "./path/to/types";

// Mock the services
jest.mock("./path/to/services", () => ({
