...
const createCompliantProvider = (entityType: string) => {
  ...
  switch (entityType) {
    ...
    case "transactionCategories":
      provider.getAllTransactionCategories = jest.fn();
      provider.getTransactionCategoryById = jest.fn();
      provider.createTransactionCategory = jest.fn();
      provider.updateTransactionCategory = jest.fn();
      provider.deleteTransactionCategory = jest.fn();
      provider.restoreTransactionCategory = jest.fn();
      provider.getTransactionCategoriesByGroup = jest.fn();
      break;

    case "transactionGroups":
      provider.getAllTransactionGroups = jest.fn();
      provider.getTransactionGroupById = jest.fn();
      provider.createTransactionGroup = jest.fn();
      provider.updateTransactionGroup = jest.fn();
      provider.deleteTransactionGroup = jest.fn();
      provider.restoreTransactionGroup = jest.fn();
      break;
