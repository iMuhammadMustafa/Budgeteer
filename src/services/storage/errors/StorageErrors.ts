...
export enum StorageErrorCode {
  ...
  // Storage mode management errors
  MODE_SWITCH_FAILED = 'MODE_SWITCH_FAILED',
  MODE_SWITCH_ROLLBACK_FAILED = 'MODE_SWITCH_ROLLBACK_FAILED',
  INDEXEDDB_NOT_SUPPORTED = 'INDEXEDDB_NOT_SUPPORTED',
  SQLITE_NOT_AVAILABLE = 'SQLITE_NOT_AVAILABLE',
  UNKNOWN_STORAGE_MODE = 'UNKNOWN_STORAGE_MODE',
