...
describe('RuntimeValidator', () => {
  ...
  describe('validateUpdate', () => {
    it('should validate valid account update', async () => {
      ...
      const result = await runtimeValidator.validateUpdate(
        'Accounts',
        updateData,
        mockDataProvider
      );
  ...
  describe('validateDelete', () => {
    it('should validate deletion of existing record', async () => {
      const result = await runtimeValidator.validateDelete(
        'accounts',
        'acc1',
        mockDataProvider
      );
  ...
  describe('business rule validation', () => {
    it('should warn about negative account balance', async () => {
      const accountData = {
        name: 'Test Account',
        categoryid: 'cat1',
        balance: -100.50, // Negative balance
        tenantid: 'tenant1'
      };
