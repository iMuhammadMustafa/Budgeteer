...
export const config = {
  light: vars({
    ...
    "--foreground": "7 11 6",
    "--muted": "229 229 229",
    "--muted-foreground": "45 45 45",
    "--popover": "245 245 243",
    "--popover-foreground": "4 3 2",
    "--card": "245 245 240",
    "--card-foreground": "4 3 2",
    "--border": "230 230 230",
    "--input": "230 230 230",
    "--primary": "135 143 120",
    "--primary-foreground": "37 25 11",
    "--secondary": "219 219 216",
    "--secondary-foreground": "56 56 54",
    "--accent": "219 219 216",
    "--accent-foreground": "56 56 54",
    "--destructive": "255 204 51",
  ...
  dark: vars({
    "--background": "24 24 24" /* HSL(210 19% 8%) */,
    "--foreground": "255 255 255" /* HSL(0 0% 100%) */,
    "--muted": "41 41 41" /* HSL(210 12% 15%) */,
    "--muted-foreground": "156 156 156" /* HSL(210 12% 65%) */,
    "--popover": "21 21 21" /* HSL(210 19% 5%) */,
    "--popover-foreground": "255 255 255" /* HSL(0 0% 100%) */,
    "--card": "19 19 19" /* HSL(210 19% 6%) */,
    "--card-foreground": "255 255 255" /* HSL(0 0% 100%) */,
    "--border": "26 26 26" /* HSL(210 9% 13%) */,
    "--input": "30 30 30" /* HSL(210 9% 16%) */,
    "--primary": "0 89 60" /* HSL(167.37 71.99% 25.05%) */,
    "--primary-foreground": "255 255 255" /* HSL(0 0% 100%) */,
    "--secondary": "64 64 64" /* HSL(0 0% 25%) */,
    "--secondary-foreground": "217 217 217" /* HSL(0 0% 85%) */,
    "--accent": "46 46 46" /* HSL(210 19% 23%) */,
    "--accent-foreground": "208 208 208" /* HSL(210 19% 83%) */,
    "--destructive": "6 245 155" /* HSL(1 95% 57%) */,
